...
class MY_Model extends CI_Model
{
    ...
    public function __construct()
    {
        ...
        if (!$this->table) { //jika nilai kosong
     ...
     * @return void
     */
    public function orlike($column, $condition) // sama seperti like tapi dengan kolom yang berbeda
    {
    ...
    public function get()
    {
        return $this->db->get($this->table)->result(); // "result()" berfungsi mengambil data dengan banyak data tapi yang ditampilkan dengan tipe data objek bukan array
    }
