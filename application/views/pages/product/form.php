        ...
        <div class="col-md-10 mx-auto">
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label>Ada Stock?</label><br />
                        <div class="form-check form-check-inline">
                            <?= form_radio([
                                'name' => 'is_available',
                                'value' => 1,
                                'checked' => isset($input->is_available) && $input->is_available == 1 ? true : false,
                        ...
                        <div class="form-check form-check-inline">
                            <?= form_radio([
                                'name' => 'is_available',
                                'value' => 0,
                                'checked' => isset($input->is_available) && $input->is_available == 0 ? true : false,
                                'class'  => 'form-check-input'
                            ]) ?>
